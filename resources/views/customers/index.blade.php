    ...
    <div class="mb-8">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-black dark:text-white tracking-tight">قائمة العملاء</h1>
                    <p class="text-gray-500 dark:text-gray-400 font-medium">إدارة وبيانات جميع العملاء المسجلين</p>
                </div>
            </div>
                        ...
                        <tr class="hover:bg-blue-50/30 dark:hover:bg-slate-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-bold dark:text-white text-lg group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{{ $customer->name }}</span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center justify-center gap-3">
                                    ...
                                    <form action="{{ route('customers.destroy', $customer) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="p-2 rounded-lg bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-600 hover:text-white transition-all shadow-sm" onclick="return confirm('هل أنت متأكد من حذف هذا العميل نهائياً؟')" title="حذف">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-20 text-center text-gray-400">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-xl font-medium">لم يتم العثور على أي عملاء.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
