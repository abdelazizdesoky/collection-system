...
<div class="container mx-auto py-8">
    <div class="mb-6 flex justify-between items-center">
        <h1 class="text-3xl font-bold">تفاصيل التسجيل #{{ $collection->receipt_no }}</h1>
        <div class="flex gap-2">
            <a href="{{ route('collections.edit', $collection) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">تعديل</a>
            <a href="{{ route('collections.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">رجوع</a>
        </div>
    </div>

    <div class="grid grid-cols-2 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-bold mb-4">تفاصيل التسجيل</h2>
            <div class="space-y-3">
                <div>
                    <span class="font-semibold">رقم التسجيل:</span>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-bold mb-4">تفاصيل الدفع</h2>
            <div class="space-y-3">
                <div>
                ...
                <div>
                    <span class="font-semibold">نوع الدفع:</span>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-lg font-bold mb-4">القيد</h2>
