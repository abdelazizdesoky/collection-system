    ...
    <div class="max-w-md mx-auto bg-white rounded-lg shadow p-6">
        ...
        <form action="{{ route('cheques.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="customer_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-right" dir="rtl" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="bank_name" value="{{ old('bank_name') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-right" required>
            </div>
