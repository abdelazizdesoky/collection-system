...
<div class="container mx-auto py-8">
    <div class="mb-6 flex justify-between items-center">
        <h1 class="text-3xl font-bold">تفاصيل الحساب</h1>
        <a href="{{ route('customer-accounts.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">رجوع</a>
    </div>

    <div class="grid grid-cols-2 gap-6">
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-bold mb-4">تفاصيل العملية</h2>
            <div class="space-y-3">
                <div>
                ...
                <div>
                    <span class="font-semibold">البيان:</span>
                    <span>{{ $customerAccount->description }}</span>
                </div>
                <div>
                    <span class="font-semibold">المرجع:</span>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-bold mb-4">تفاصيل المبلغ</h2>
            <div class="space-y-3">
                <div>
                    <span class="font-semibold">مدين (المبلغ المستحق):</span>
                    <span class="text-2xl font-bold text-red-600">{{ number_format($customerAccount->debit, 2) }}</span>
                </div>
                <div>
                    <span class="font-semibold">دائن (المبلغ المدفوع):</span>
