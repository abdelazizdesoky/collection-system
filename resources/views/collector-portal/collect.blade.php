        ...
        <form action="{{ route('collector.collect.store', $planItem) }}" method="POST" enctype="multipart/form-data" id="collectionForm">
            ...
            <div id="cheque_fields" class="hidden space-y-5 mb-5 p-4 bg-blue-50/50 dark:bg-blue-900/10 rounded-2xl border border-blue-100 dark:border-blue-500/30">
                ...
                <div>
                    ...
                    <input type="text" name="bank_name_cheque" value="{{ old('bank_name_cheque') }}" list="banks" class="w-full px-4 py-3 border-2 border-white dark:border-slate-700 bg-white dark:bg-slate-800 rounded-xl focus:outline-none focus:border-blue-500 dark:text-white" placeholder="اختر البنك">
                    <datalist id="banks">
            ...
            <div id="transfer_fields" class="hidden space-y-5 mb-5 p-4 bg-amber-50/50 dark:bg-amber-900/10 rounded-2xl border border-amber-100 dark:border-amber-500/30">
                <div>
                    ...
                    <input type="text" name="bank_name_transfer" value="{{ old('bank_name_transfer') }}" list="banks" class="w-full px-4 py-3 border-2 border-white dark:border-slate-700 bg-white dark:bg-slate-800 rounded-xl focus:outline-none focus:border-amber-500 dark:text-white" placeholder="اختر البنك">
                </div>
                <div>
