...
<div class="container mx-auto py-8 px-4 text-right" dir="rtl">
    ...
    <div class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('installments.print', $plan) }}" target="_blank" class="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-xl transition-all shadow-lg shadow-indigo-500/30">
