...
<div class="container mx-auto py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold">Collection Plans</h1>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach ($plans as $plan)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ $plan->date->format('M d, Y') }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap font-semibold">₹{{ number_format($plan->getTotalExpectedAmount(), 2) }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('collection-plans.show', $plan) }}" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                            <a href="{{ route('collection-plans.edit', $plan) }}" class="text-yellow-600 hover:text-yellow-900 mr-3">Edit</a>
