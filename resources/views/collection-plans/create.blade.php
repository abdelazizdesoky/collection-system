...
<div class="container mx-auto py-8">
    <div class="max-w-md mx-auto bg-white rounded-lg shadow p-6">
        <h1 class="text-2xl font-bold mb-6">Create Collection Plan</h1>
        ...
        <form action="{{ route('collection-plans.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g., Weekly Cash Collection" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="plan_date" value="{{ old('plan_date') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            ...
            <div class="mb-4">
                ...
                <select name="collection_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <option value="regular" {{ old('collection_type') == 'regular' ? 'selected' : '' }}>Regular</option>
                    <option value="special" {{ old('collection_type') == 'special' ? 'selected' : '' }}>Special</option>
                </select>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="type" value="{{ old('type') }}" placeholder="e.g., Cash collection from showroom" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('collection-plans.index') }}" class="flex-1 bg-gray-400 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded text-center">Cancel</a>
            </div>
        </form>
    </div>
</div>
