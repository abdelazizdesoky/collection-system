...
<div class="max-w-7xl mx-auto text-right" dir="rtl">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Total Customers -->
        <div class="bg-white dark:bg-dark-card rounded-2xl shadow-xl shadow-indigo-500/5 border border-gray-100 dark:border-dark-border p-6 hover:border-indigo-500/50 transition-all group">
        ...
        <!-- Total Collectors -->
        <div class="bg-white dark:bg-dark-card rounded-2xl shadow-xl shadow-emerald-500/5 border border-gray-100 dark:border-dark-border p-6 hover:border-emerald-500/50 transition-all group">
            <div class="flex flex-col items-center text-center">
        ...
        <!-- Total Collections -->
        <div class="bg-white dark:bg-dark-card rounded-2xl shadow-xl shadow-amber-500/5 border border-gray-100 dark:border-dark-border p-6 hover:border-amber-500/50 transition-all group">
            <div class="flex flex-col items-center text-center">
        ...
        <!-- Pending Cheques -->
        <div class="bg-white dark:bg-dark-card rounded-2xl shadow-xl shadow-rose-500/5 border border-gray-100 dark:border-dark-border p-6 hover:border-rose-500/50 transition-all group">
            <div class="flex flex-col items-center text-center">
                <div class="bg-rose-50 dark:bg-rose-900/20 p-4 rounded-2xl text-rose-600 dark:text-rose-400 mb-4 group-hover:scale-110 transition-transform">
                ...
                <table class="w-full text-right border-collapse">
                    <thead>
                        <tr class="bg-gray-50/80 dark:bg-dark-tableheader/30 text-gray-400 text-[10px] font-black uppercase tracking-wider">
                            ...
                            <th class="px-6 py-4 text-center">الصلاحيات</th>
                        ...
                        @foreach($users as $user)
                            <tr class="hover:bg-blue-50/30 dark:hover:bg-slate-700/30 transition-colors group">
                                    ...
                                    <div class="flex flex-wrap justify-center gap-1.5">
                                        @foreach($user->roles as $role)
                                            <span class="px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-tighter
                                                @if($role->name === 'admin') bg-indigo-600 text-white
                                                @elseif($role->name === 'supervisor') bg-amber-500 text-white
                                ...
                                <td class="px-6 py-5 text-center">
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 text-[10px] font-black rounded-full">
                                        <span class="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></span>
                                        نشط
                                    </span>
                                </td>
                                <td class="px-6 py-5 text-left">
                                    <button onclick="openRoleModal({{ $user->id }}, '{{ $user->name }}')" class="p-2 rounded-lg bg-gray-100 dark:bg-dark-bg/50 text-gray-500 dark:text-gray-400 hover:bg-indigo-600 hover:text-white transition-all border border-gray-200 dark:border-dark-border group-hover:border-indigo-600">
